...
# Appologies that the line length is compressed muh shorter than 80 characters
# for most of this code. I wrote it on a plain text editor and didn't take much
# care to justify the length of lines.
...
# idexing and error handling when requesting cells from the board. I've left the
# code here commented out in case I want to upgrade it later.
...
def tic_tac_toe():
    ...
    # Played
    count = 0
    # TODO: You might be better off changing this to winner = ' '
    winner = None
    ...
    # TODO: Write a function that allows players to play a tournament or a 
    # best-of-three by keeping score of how many wins a player has had.
    return(winner)
